                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <div class="mt-4 md:mt-0 flex flex-col items-end gap-4">
                        <div class="bg-electric-orange-50 p-4 rounded-lg">
                            <p class="text-electric-orange-800"><span class="font-medium">Email:</span> {{ $owner->email }}</p>
                            <p class="text-electric-orange-800"><span class="font-medium">Total Rooms:</span> {{ $rooms->count() }}</p>
                        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border border-electric-orange-200 flex flex-col h-full">
                        <div class="flex-grow">
