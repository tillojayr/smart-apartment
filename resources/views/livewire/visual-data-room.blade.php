                ...
                @if ($isAdmin)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-electric-orange-200">
                            ...
                            <p class="text-3xl font-bold text-electric-orange-600">
                                {{ number_format($totalConsumption ?? 0, 2) }} kWh</p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-electric-orange-200">
                            ...
                            <p class="text-3xl font-bold text-electric-orange-600">
                                {{ number_format($averageVoltage, 1) }}V</p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-electric-orange-200">
                            ...
                            <p class="text-3xl font-bold text-electric-orange-600">
                                {{ number_format($averageCurrent, 1) }}A</p>
                        </div>
                    </div>
                @else
                    <div class="mb-6">
                        <h2 class="text-2xl font-semibold text-electric-orange-800">Room {{ $room->room_number }} Data
                        </h2>
            ...
            async function fetchChartData(startDate, endDate) {
                try {
                    ...
                    const response = await fetch(
                        `/api/chart-data?owner_id=${ownerId}&room_id=${roomId}&start_date=${startDate}&end_date=${endDate}`, {
                            headers: {
